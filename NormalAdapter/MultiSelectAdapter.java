...
public class MultiSelectAdapter extends RecyclerView.Adapter<MultiSelectAdapter.MyViewHolder> {
    ...
    public MultiSelectAdapter(Context context, ArrayList<TxpGetSet> phraseList, ArrayList<TxpGetSet> selectedList, OnRecyclerItemClickListener onRecyclerItemClickListener) {
